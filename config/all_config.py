...
class AllConfig(Config):
    ...
    def parse_args(self):
        ...
        parser.add_argument("--train_file", type=str, required=False, help="Location of train file")
        parser.add_argument("--test_file", type=str, required=True, help="Location of test file")
        ...
        parser.add_argument("--log_step", type=int, default=60, help="Print training log every n steps")
